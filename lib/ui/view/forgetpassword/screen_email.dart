...
class Emailscreen extends StatelessWidget {
  ...
  static const String emailroutename ='maill';
  GlobalKey forme = GlobalKey();
  @override
           ...
           child: SingleChildScrollView(
             child: Column(
               ...
               children: [
                 ...
                 SizedBox(height: 40,),
                 Text('Forget Password.', style: TextStyle(fontSize: 24,fontWeight: FontWeight.w600),),
                 SizedBox(height: 15,),
                 Text('Enter your email address below to reset your password.', style: TextStyle(fontSize: 16),),
                 SizedBox(height: 50,),
                 ...
                 Container(
                   ...
                   child: ElevatedButton(onPressed: (){
                     Navigator.pushNamed(context, Otpscreen.otproutename);
                   },
